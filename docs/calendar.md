...
Each slip is `#id`, title, and the same raised-date age chip as the board. Days show four slips, then **+N more** opens every card that day. The project calendar also prints the board name and offers chips to hide boards (`?boards=`).
