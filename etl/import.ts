 ...
 * DB owns: lane, rank, priority, effort, target, audience (after first import), summary (once edited in the app), body_md (once body_edited_at is set), archive.
...
const { data: existingRows } = await db
  .from("cards")
  .select(
    "id, external_id, lane_id, lane_from_source, rank, priority, effort, source_hash, summary, summary_edited_at, audience, body_md, body_edited_at",
  )
